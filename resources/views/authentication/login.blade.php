                ...
                <div class="flex flex-col">
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            type="text" placeholder="Enter your full name" name="email">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-xs text-customGreen font-semibold cursor-pointer text-end mt-2">Forgot Password?
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col gap-6">
                        <button class="bg-customGreen border rounded h-10 hover:brightness-95 text-white">Login</button>
