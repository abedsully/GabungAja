            ...
            <!-- <ul class="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
                <li>
                  ...
                  <div class="timeline-start md:text-end mb-10">
                    <time class="font-mono italic">February</time>
                    <div class="text-lg font-black">The Beginning</div>
                    Our group has decided to build an online platform for communities.
                  </div>
                  <hr/>
                </li>
                <li>
                  ...
                  <div class="timeline-end mb-10">
                    <time class="font-mono italic">March</time>
                ...
                <li>
                  ...
                  <div class="timeline-start md:text-end mb-10">
                    <time class="font-mono italic">April</time>
                ...
                <li>
                  ...
                  <div class="timeline-end mb-10">
                    <time class="font-mono italic">May</time>
                ...
                <li>
                  ...
                  <div class="timeline-start md:text-end mb-10">
                    <time class="font-mono italic">June</time>
